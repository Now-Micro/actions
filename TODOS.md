...
## next prompts
- Replace the inline bash step in checks.yml with this new composite action (cleaner & reusable).
- Run the full repo tests and iterate until coverage target (>90%) is reached.